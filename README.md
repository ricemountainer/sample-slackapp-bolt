A sample (and very simple) Slack App, built by Bolt and Typescript. The app can be run on a typical server runtime e.g. AWS EC2, Heroku... The Slack app communicates with Slack through WebSocket (Interective Mode).
...
- `heroku config:set YARN_PRODUCTION=false -a [your heroku app name]`
